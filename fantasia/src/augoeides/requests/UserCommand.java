        ...
        if (cmd.equals("mute")) {
            ...
            if (params[1].startsWith("@")) {
                ...
                if ((((Integer) user.properties.get("access")).intValue()) == 61) {
                    world.send(new String[]{"administrator", "(DaemonX): " + var13}, world.zone.getChannelList());
                ...
                /*
                if ((((Integer) user.properties.get("access")).intValue()) == 61) {
                    world.send(new String[]{"daemon", "(" + var11 + "): " + var13}, world.zone.getChannelList());
                } else if ((((Integer) user.properties.get("access")).intValue()) == 60) {
                    world.send(new String[]{"administrator", "(" + var11 + "): " + var13}, world.zone.getChannelList());
